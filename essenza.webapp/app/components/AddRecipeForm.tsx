...
import { recipeSchema, formatZodErrors, type FieldErrors } from "../lib/validation";
...
export default function AddRecipeForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    setLoading(true);
    setSubmitted(true); // Ab jetzt Fehler anzeigen
    setError("");
    ...
    // FormData aufbauen und Server Action aufrufen
    try {
